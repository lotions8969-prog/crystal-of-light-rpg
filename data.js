const GAME_DATA = {
  ...
  monsters: {
    ...
    forestTroll:{ name:'フォレストトロール', hp:130, atk:24, def:12, spd:8, exp:200, gold:80, emoji:'👹', color:'#33691E', sprite:'forestTroll', isBoss:true, actions:['attack','attack','smash','regen'] },
    ...
    caveDragon:{ name:'ケイブドラゴン', hp:320, atk:40, def:22, spd:12, exp:550, gold:200, emoji:'🐲', color:'#D32F2F', sprite:'caveDragon',  isBoss:true, actions:['attack','breath','breath','tailSwipe'], phase2Trigger:160 },
    ...
    demonKing: { name:'魔王ゾルディアーク', hp:850, atk:78, def:42, spd:20, exp:9999, gold:9999, emoji:'👑', color:'#1a0020', sprite:'demonKing', isBoss:true, actions:['attack','attack','darkBlast','darkBlast','drain','rage'], phase2Trigger:425 },
  },
  areas: {
